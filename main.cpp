...
Appuyez sur fleche du bas ou fleche du haut pour faire monter le premier point placé avec la souris

Pour dessine un trait : appuyez pour placer le premier point et maintenez appuyé puis relâchez pour placer le deuxième point.
...
struct point{
    ...
    float mus = 0.4;         //Variables pour le carré    |||VALEUR DU COEFFICIENT DE FROTTEMENT|||
